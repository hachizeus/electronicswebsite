<template>
  <div class="category-shop">
    ...
    <Swiper
      class="swiper"
      :modules="modules"
      :slides-per-view="window.width > 767 ? 3 : 1"
      :space-between="15"
      ...
      myCategory: [
        {
          ...
          img: require("@/assets/Category/category-1.png"),
          features: [
            "Desktops",
            "Laptops / Notebooks",
            "Gaming Laptops",
        ...
        },
        {
          ...
          img: require("@/assets/Category/category-2.png"),
          features: [
            "Video Game",
            "Wireless Printer",
            "Jonor Magicbook",
        ...
        {
          title: "Camera & Videos",
          img: require("@/assets/Category/category-3.png"),
          features: [
            "Full HD",
            "Polaroid Camera",
            "Gadgets",
        ...
        },
        {
          ...
          img: require("@/assets/Category/category-4.png"),
          features: [
            "Smart Watches",
            "Wireless Screen",
            "Night Led",
